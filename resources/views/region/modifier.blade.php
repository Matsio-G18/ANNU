...
<html lang="fr">
    <head>
        ...
        <title>@yield('PAIC')|Ajouter une region</title>
    </head>
    <body>
        <h1>Enregistrer une nouvelle region</h1>
            @if(session('status'))
        ...
        <form class="form-control" method="POST" action="">
            @csrf
            <input class="" type="text" placeholder="Nom de la region">
            <input type="button" class=" btn btn-success" value="Ajouter une region">
        </form>
    </body>
</html>